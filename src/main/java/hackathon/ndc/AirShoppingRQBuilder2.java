...
public class AirShoppingRQBuilder2 {
	...
	public AirShoppingRQBuilder2() {
		anonymousTravelers = new HashMap<AirShoppingRQBuilder2.Traveler, Integer>();
	...
	public AirShoppingRQBuilder2 addTravelAgencySender(String name, String iataNumber, String agencyId) {
	...
	public AirShoppingRQBuilder2 addAnonymousTraveler(Traveler traveler) {
		return addAnonymousTravelers(traveler, 1);
	}

	public AirShoppingRQBuilder2 addAnonymousTravelers(Traveler traveler, int count) {
	...
	public AirShoppingRQBuilder2 addOriginDestination(AirShopReqAttributeQueryTypeOriginDestination originDestination) {
		request.getCoreQuery().getOriginDestinations().add(originDestination);
		return this;
	}

	public AirShoppingRQBuilder2 addOriginDestination(String origin, String destination, Date date) {
		return addOriginDestination(origin, destination, date, 0, 0);
	}

	public AirShoppingRQBuilder2 addOriginDestination(String origin, String destination, Date date, int daysBefore, int daysAfter) {
	...
	public AirShoppingRQBuilder2 addAirlinePreference(String airlineId) {
		airlines.add(airlineId);

		return this;
	}

	public AirShoppingRQBuilder2 addFarePreference(String fareCode) {
		fares.add(fareCode);

		return this;
	}

	public AirShoppingRQBuilder2 addCabinPreference(String cabinCode) {
